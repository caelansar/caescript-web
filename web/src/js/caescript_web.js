...
* @returns {string}
*/
export function cae_interpreter_eval(input) {
    let deferred2_0;
    let deferred2_1;
    try {
        ...
        wasm.cae_interpreter_eval(retptr, ptr0, len0);
...
* @returns {string}
*/
export function cae_vm_eval(input) {
    let deferred2_0;
    let deferred2_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(input, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.cae_vm_eval(retptr, ptr0, len0);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        deferred2_0 = r0;
        deferred2_1 = r1;
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('caescript_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
